...
export const EVD_POSITIVE_COLOR = "#F6ECEB";
export const EVD_POSITIVE_BORDER_COLOR = "#B63F39";
export const EVD_NEGATIVE_COLOR = "#E8F1E0";
export const EVD_NEGATIVE_BORDER_COLOR = "#A4CA82";
