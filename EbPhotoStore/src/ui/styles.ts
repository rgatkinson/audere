...
export const DEMO_MODE_COLOR = "rgba(1, 128, 1, 0.5)";
export const EBOLA_POSITIVE_COLOR = "#CE1021";
export const EBOLA_NEGATIVE_COLOR = "#5E9749";
export const CHAT_REMOTE_MESSAGE_COLOR = "#DBDBDB";
export const CHAT_LOCAL_MESSAGE_COLOR = "#B8E1FF";
