    ...
    new ManagedMaterializedView({
      ...
      spec: `
        select
          ...
          c.survey->'previewSeries' as previewSeries,
          ...
          c.survey->'rdtInfo'->'rdtReaderResult'->>'failureReason' as rdtreaderresult_failureReason,
    ...
    new ManagedView({
      ...
      spec: `
        select
          ...
          inbound_barcode,
          shipped_timestamp,
          kit_registration_code,
          strip_temp_status,
          rejection_reason,
          flu_a_result,
          flu_a_value,
          flu_a_assay_timestamp,
          flu_b_result,
          flu_b_value,
          flu_b_assay_timestamp,
          rsv_result,
          rsv_value,
          rsv_assay_timestamp,
          received,
