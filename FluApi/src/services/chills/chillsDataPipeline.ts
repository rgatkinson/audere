    ...
    new ManagedMaterializedView({
      ...
      spec: `
        select
          ...
          c.device->'clientVersion'->>'rdtVersionAndroid' as clientversion_rdt_android,
          c.device->'clientVersion'->>'rdtVersionIos' as clientversion_rdt_ios,
          ...
          c.survey->'rdtInfo'->>'flashDisabledAutomatically' as rdtinfo_flashdisabledautomatically,
          c.survey->'rdtInfo'->'rdtReaderResult'->>'testStripFound' as rdtreaderresult_teststripfound,
          ...
          c.survey->'rdtInfo'->'rdtReaderResult'->>'sizeResult' as rdtreaderresult_sizeresult,
          c.survey->'rdtInfo'->'rdtReaderResult'->>'isFocused' as rdtreaderresult_isfocused,
          c.survey->'rdtInfo'->'rdtReaderResult'->>'angle' as rdtreaderresult_angle,
          c.survey->'rdtInfo'->'rdtReaderResult'->>'isRightOrientation' as rdtreaderresult_isrightorientation,
