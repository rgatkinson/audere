...
} from "../core/sql/sqlNodes";
import {
  OptionQuestion,
  SURVEY_QUESTIONS,
  SurveyQuestion,
  SurveyQuestionType,
} from "audere-lib/dist/coughQuestionConfig";
import { SQLTask } from "../core/sql/sqlTask";
import { Sequelize } from "sequelize";

const DEBUG_DATA_PIPELINE = false;

export class DerivedTask extends SQLTask {
