export const CONSENT_FORM_TEXT = `
UNIVERSITY OF WASHINGTON Consent Form: Ages 18 and up Assent Form: Ages 13-17

Respiratory Virus Surveillance in an Urban Setting

Researchers: [List names, academic/staff positions, divisions/departments, telephone numbers of lead researcher (PI), contact person for subjects) Researchers’ statement We are asking you to be in a research study. The purpose of this consent form is to give you the information you will need to help you decide whether to be in the study or not. Please read the form carefully. You may ask questions about the purpose of the research, what we would ask you to do, the possible risks and benefits, your rights as a volunteer, and anything else about the research or this form that is not clear. When we have answered all your questions, you can decide if you want to be in the study or not. This process is called “informed consent.” We will give you a copy of this form for your records. This document is also used for legally-authorized representatives of subjects to provide permission to the research team for individuals who are not capable of providing permission themselves. In such cases, the terms “you” refers to the subject. PURPOSE OF THE STUDY The goal of this study is to determine the rate and spread of respiratory viruses in an urban area. Respiratory viruses commonly infect adults and children. Infection is usually mild in healthy adults and children, leading to runny noses, coughing, and wheezing. However, infection can become more serious, especially in older and very young people and those with lung diseases or weak immune systems.

STUDY PROCEDURES You are being invited to join this study you are experiencing the symptoms of a respiratory virus. If you join this study, participating in this study will include:

Survey At the beginning of the study we will ask you some questions about your basic demographics (such as age, race, ethnicity, etc.), your family, your health, and your home. We think these questions will take about 15 minutes to answer. You are free to refuse to answer any of these questions

We may also ask you questions about whether you would be willing to do things in future studies, such as getting your own nasal swab or wearing a device like a fitbit to see where you go during the day. We would not be asking you to do these things as part of this study asking you if you might be willing to do it another time.

Nasal swabs We will collect a nasal swab one-time. We would collect a nasal swab by gently putting a swab (like a Q-tip) into your nose and gently turning it around.

Medical records If you are in the hospital when you join the study, reviewing your medical record for lung infections or other medical history. We are asking for your permission to review your medical records for lung illness and other medical conditions that could have contributed to your respiratory viral infection.

RISKS, STRESS, OR DISCOMFORT We do not expect serious side effects from this study. Getting the nasal swab may cause some mild discomfort, watery eyes, or sneezing. Some of the questions in this questionnaire are sensitive and may make you feel uncomfortable. You do not have to answer any question you do not want to. There is a risk that your confidentiality or privacy could be breached.  This would mean that someone other the research team or our collaborators might find out that you were in the research or see your answers or medical information. However, we will take every precaution to make sure that this does not happen.

BENEFITS OF THE STUDY This study will not benefit you directly. It may help others in the future by learning which respiratory viruses make people ill and how they spread.

SOURCE OF FUNDING This study is funded by the Gates Foundation

CONFIDENTIALITY OF RESEARCH INFORMATION Your record will be kept confidential. You will not be identified in any report or publication about this study. All records will be kept in locked files at [X]
...
OTHER INFORMATION You may refuse to participate and you are free to withdraw from this study at any time without penalty or loss of benefits to which you are otherwise entitled. We will send you the results of your viral testing within 1 month of sample collection. If you join the study when you have symptoms of a respiratory virus and agree to have a nasal swab collected and answer our questions, you will receive a $5 gift card for participating in this study.
...
SPECIMEN BANKING Storing samples so researchers can use it in the future is called “banking.” Researchers also bank information/samples so they can share it with other researchers. Your sample would be stored for up to 10 years after the completion of the study. Your sample will only be labeled with a study code and will not be labeled with your name or other identifying information. We would not be able to give you the results from research that is done using your sample. You could always tell us to stop storing your sample and we would destroy your sample.
