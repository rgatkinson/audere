    ...
    return (
      <ScreenContainer>
        ...
        <ContentContainer>
          ...
          <Description
            content="You do not qualify for the Seattle Flu Study at this time. Please provide your email address below if you are interested in learning more about this study and related topics in the future."
          />
          <EmailInput
            autoFocus={true}
            returnKeyType='done'
