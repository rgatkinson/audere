...
export const questionnaire = [
  ...
  },
  {
    section: expo,
    data: {
      description: 'Next, we are going to ask you some questions about people you may have been in contact with. For the purposes of this study, we define contact as physical touching between you and another person, or being within 6 feet of another person for at least two minutes. As a reference, 6 feet is approximately 2 rows of a city bus.',
      buttons: [
  ...
  },
  {
    section: expo,
    data: {
      title: 'In the past week, have you been in contact with a person with cough, sore throat, or fever?',
      buttons: [
  ...
  },
  {
    section: expo,
    data: {
      title: 'In the past week, have you been in contact with any children under 5 years of age for over an hour?',
      buttons: [
        { label: 'Done', primary: true },
      ],
    },
  },
  {
    section: expo,
    data: {
      title: 'Do any children in your household attend a school, childcare setting, or play group with at least 3 other children for 3 or more hours / week?',
      buttons: [
        { label: 'Yes', primary: true },
        { label: 'No', primary: true },
        { label: 'Do Not Know', primary: false },
  ...
  },
  {
    section: expo,
    data: {
      title: 'Over the last 4 weeks, where have you spent the majority of your waking hours?',
      buttons: [
        { label: 'Done', primary: true },
      ],
    },
  ...
  },
  {
    section: expo,
    data: {
      title: 'Please provide the address or location name of your primary place of employment.',
      buttons: [
        { label: 'Done', primary: true },
      ],
    },
  ...
  },
  {
    section: expo,
    data: {
      title: 'Thinking of a typical day, how many people do you come into contact with?',
      buttons: [
        { label: 'Done', primary: true },
        { label: 'Do Not Know', primary: false },
      ],
  ...
  },
  {
    section: hist,
    data: { 
      title: 'Have you taken any antibiotics or antivirals for your current illness?',
      buttons: [
        { label: 'Yes', primary: true },
        { label: 'No', primary: true },
        { label: 'Do Not Know', primary: false },
